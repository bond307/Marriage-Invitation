...
$txt = "Reset the password  through this link http://www.mymarriageinvitation.com/resetpassword.php?username=$to";
$headers = "From: contact@mymarriageinvitation.com" . "\r\n" .
"CC: ";
    if(mail($to,$subject,$txt,$headers))
    {
       $message="<div class='alert alert-danger'>
        Please check your Mail</div>";
    }
}
?>
<!DOCTYPE html>
                ...
                <div class="col-lg-6">
                    ...
                    <form class="nile-content cart dark invitation" form action="" method="post">
                        ...
                        <div class="text-center">
                                <button type="submit" name="send" class="nile-bottom layout-2">Verify</button>
                        </div>
                    </form>  
