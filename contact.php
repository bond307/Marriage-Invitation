...
<head>
    <title>Marriage Invitation - Contact</title>
...
<body class="background-white">
                    ...
                    <div class="position-relative">
                        <div class="row">
                            <div class="col-lg-3 col-md-12">
                                <a id="logo" href="index.php" class="d-inline-block margin-tb-15px"><img src="assets/img/logo1.png" class="nav-logo" alt=""></a>
    ...
    <div class="page-output padding-tb-100px">
        ...
        <div class="container padding-bottom-120px">
            ...
            <div class="row">
                ...
                <div class="col-lg-3">
                    <div class="icon-text layout-1">
                        ...
                        <h3>Location</h3>
                        <div class="dis">Dwaraka Tirumala<br>West Godavari, Andhra Pradesh</div>
                    </div>
                </div>
                ...
                <div class="col-lg-3">
                    <div class="icon-text layout-1">
                        ...
                        <h3>E-mail</h3>
                        <div class="dis">mymarriageinvitation.com@gmail.com</div>
                    </div>
                </div>
                ...
                <div class="col-lg-3">
                    <div class="icon-text layout-1">
                        ...
                        <h3>Website</h3>
                        <div class="dis">www.mymarriageinvitation.com</div>
                    </div>
                </div>
                ...
                <div class="col-lg-3">
                    <div class="icon-text layout-1">
                        ...
                        <h3>WhatsApp / Call</h3>
                        <div class="dis">+91 63095 02137</div>
                    </div>
                </div>
    ...
    <!-- preloader --> <div class="nile-preloader"> <div class="logo"> <img src="assets/img/loading-1.svg" alt=""> </div> </div> <!-- end preloader --> <footer class="layout-1 padding-tb-130px">
        <div class="container">
