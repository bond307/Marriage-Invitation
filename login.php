...
<head>
    <title>Marriage Invitation - Login</title>
...
<body class="background-white" style="background-image: url('assets/img/page_title.jpg'); background-repeat: no-repeat; background-size: cover; background-position: center;">
        ...
        <div class="container padding-top-100px">
            <div class="section-title layout-1 text-center">
                ...
                <div class="col-lg-6">
                    ...
                    ?>
                    <form class="nile-content cart dark invitation" method="POST" action="">
                        <div class="form-row">
                        ...
                        <div class="text-center">
                                <button type="submit" name="signin" class="nile-bottom layout-2">Sign In</button> New customer?
                                <a class="nile-bottom layout-2" href="register.php">Sign Up</a>
                        </div><br>
                        <div class="col-md-12">
                            <a href="forgot_password.php" class="nile-bottom sm">Forgot password?</a>
                        </div>
                    </form>  
    ...
    <!-- preloader --> <div class="nile-preloader"> <div class="logo"> <img src="assets/img/loading-1.svg" alt=""> </div> </div> <!-- end preloader --> 
    <footer class="padding-tb-50px">
