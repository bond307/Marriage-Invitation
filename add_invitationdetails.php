...
{
	?>	
	 <div class='alert alert-danger'>You are selected the Demo Model(IM 010) Price ₹299</div>
								 ...
								 <form action="" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="form-row">
                                        <div class="col-md-2 form-group">
                                            <label for="photo"><b>Add groom,bride photos(single and combined):</b></label>
                                        </div>
                                        <div class="col-md-10 form-group">
                                            <input class="form-control" type="file" name="files[]" id="file" multiple required>
                                        </div>
                                        </div>
                                    <div class="form-row">
                                        <div class="col-md-2 form-group">
