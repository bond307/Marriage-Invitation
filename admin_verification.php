...
$txt = "register through this link    http://www.mymarriageinvitation.com/admin_register.php";
$headers = "From: info@mymarriageinvitation.com" . "\r\n" .
"CC: somebodyelse@example.com";
mail($to,$subject,$txt,$headers);
    if(mail($to,$subject,$txt,$headers))
    {
       $message="<div class='alert alert-danger'>
        Please check your Mail ID</div>";
    }
}
?>
<!DOCTYPE html>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-7 col-md-12 position-inherit">
                                ...
                                <ul id="menu-main" class="nav-menu float-xl-right text-lg-center link-padding-tb-35px dropdown-light">
                                    ...
                                    <li class=" "><a href="purchase.php">Purchase Invitation</a></li>
                            ...
                            <div class="col-lg-2 col-md-12  d-none d-lg-block text-right">
                                <div class="margin-tb-25px">
                                    <a href="login.php" class="invitation-bot"><i class="fa fa-heart-o"></i> Login</a>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="container padding-top-100px">
            <div class="section-title layout-1 text-center">
                ...
                <div class="col-lg-6">
                    ...
                    ?>
                    <form class="nile-content cart dark invitation" form action="" method="post">
                        <div class="form-row">
                        ...
                        <div class="text-center">
                                <button type="submit" name="send" class="nile-bottom layout-2">Send verification link</button>
                        </div>
                    </form>  
