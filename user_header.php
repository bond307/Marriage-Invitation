...
require("config.php");
    ...
    $sql="SELECT * FROM payment_details WHERE user_id='$id' AND user_permission=4";
...
<body>
    ...
    <div class="hk-wrapper hk-vertical-nav">
        ...
        <nav class="navbar navbar-expand-xl navbar-light fixed-top hk-navbar">
            ...
            <a class="navbar-brand font-weight-700" href="user_home.php">
            ...
            <ul class="navbar-nav hk-navbar-content">
                ...
                <li class="nav-item dropdown dropdown-notifications">
                    ...
                    aria-expanded="false"><span class="feather-icon"><i data-feather="bell"></i></span><span class="badge-wrap">
                            ...
                            <a href="javascript:void(0);" class="dropdown-item">
                                <div class="media">
                                    ...
                                    <div class="media-body">
                                        <div>
                                            <div class="notifications-text">Welcome to mymarriageinvitation.com<span class="text-dark text-capitalize"> 
                                           </span>
            ...
            <div class="nicescroll-bar">
                <div class="navbar-nav-wrap">
                    <ul class="navbar-nav flex-column">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="user.php" data-target="#auth_drp">
                                <span class="feather-icon"><i data-feather="zap"></i></span>
                                <span class="nav-link-text">Add Inviation</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="demo.php" data-target="#pages_drp">
                                <span class="feather-icon"><i data-feather="file-text"></i></span>
                                <span class="nav-link-text">Select the Demo and Pay</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="edit_invitation.php"  data-target="#pages_drp">
                                <span class="feather-icon"><i data-feather="file-text"></i></span>
                                <span class="nav-link-text">View/Update invitation details</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="track.php" data-target="#pages_drp">
                                <span class="feather-icon"><i data-feather="file-text"></i></span>
                                <span class="nav-link-text">Track your order</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="send_invitation.php" data-target="#pages_drp">
                                <span class="feather-icon"><i data-feather="file-text"></i></span>
                                <span class="nav-link-text">Send invitation link to your friends</span>
                            </a>
                        </li>
                    </ul>
                </div>
